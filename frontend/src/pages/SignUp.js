...
import ImagesTobases64 from '../helpers/ImagesTobases64.js'
...
const SignUp = () => {
    ...
    const handleUploadPic = async (e) => {
        ...
        const imagePic = await ImagesTobases64(files)
    ...
    const handleSubmit = async (e) => {
        ...
        if (data.password === data.confirmPassword) {
            ...
            toast.error('cheack the password and confirmPassword')
            // console.log('cheack the password and confirmPassword')
        }
    }

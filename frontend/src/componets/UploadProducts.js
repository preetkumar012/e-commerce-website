...
const UpdateProducts = ({ onClose,fetchdata }) => {
        ...
        <div className='fixed w-full  h-full  bg-opacity-35 bg-slate-200 right-0 bottom-0 top-0 left-0 flex justify-center items-center'>
            <div className='bg-white  p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
                ...
                <form  onSubmit={handleSubmit} className=' grid p-4 gap-2 overflow-y-scroll h-full pb-4'>
                    ...
                    <select required value={data.category} name="category" onChange={handleOnChange} className='border rounded p-2 bg-slate-100 '>
                    ...
                    <div className='border rounded p-2 bg-slate-100 h-32 w-full flex justify-center items-center cursor-pointer'>
                        <label htmlFor="uploadImageInput">
                            ...
                            <input type="file" id='uploadImageInput' name="uploadImageInput" className="hidden" onChange={handleUploadProduct}></input>
                        </label>
                    </div>
                    ...
                    <button className="bg-red-400 text-white px-2 py-1 hover:bg-red-700 mb-10">Upload Product</button>
                </form>
            </div >
